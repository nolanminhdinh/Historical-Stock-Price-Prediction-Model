...
##  2. Kiến trúc Mô hình: Mô phỏng Tư duy Nhà đầu tư (Model Architecture)
...
### 2.1. Quan sát & Nhận diện (Feature Extraction - CNN)
...
### 2.2. Phân tích Xu hướng Chuỗi (Trend Analysis - Bi-LSTM)
...
### 2.3. Tập trung vào Điểm đột biến (Attention Mechanism)
